<template>
  <div class="shoplist">
    ...
    <el-table :data="shopList" border style="width: 100%">
      ...
      <el-table-column prop="date" label="订单编号" width="">
        <template slot-scope="scope">

        </template>
      </el-table-column>
      <el-table-column prop="" label="用户名" width="">
      </el-table-column>
      <el-table-column prop="" label="开票金额" width="">
        <template slot-scope="scope">

        </template>
      </el-table-column>
      <el-table-column prop="" label="抬头" width="">
        <template slot-scope="scope">

        </template>
      </el-table-column>
      <el-table-column prop="" label="发票内容" width="">
      </el-table-column>
      <el-table-column prop="" label="纳税人识别号" width="">
        <template slot-scope="scope">
